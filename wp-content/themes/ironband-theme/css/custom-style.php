...
//
$xt_styles->setBackground('.heading h1, .container, .iron_widget_newsletter', 'content_background', true);
...
$xt_styles->setBackground('.block .holder .title-box, section .heading, .panel__heading', 'blocks_header_background');
...
$xt_styles->setColor('.block .holder .title-box a.link, section .heading a, .panel__heading a', 'blocks_header_link_color');
