...
/* Gig Post Type (gig)
   ========================================================================== */
	...
	$static_page = get_iron_option('page_for_gigs');

	$gig_args = $default_args;
/*
	if ( get_option('permalink_structure') )
		$gig_args['has_archive'] = ( $static_page > 0 ? false : trim(str_replace( home_url(), '', post_permalink($static_page) ), '/') );
*/
...
/* Video Post Type (video)
   ========================================================================== */
	...
	$static_page = get_iron_option('page_for_videos');

	$video_args = $default_args;
/*
	if ( get_option('permalink_structure') )
		$video_args['has_archive'] = ( $static_page > 0 ? false : trim(str_replace( home_url(), '', post_permalink($static_page) ), '/') );
*/
...
/* Photo Post Type (photo)
   ========================================================================== */
	...
	$static_page = get_iron_option('page_for_photos');

	$photo_args = $default_args;
/*
	if ( get_option('permalink_structure') )
		$photo_args['has_archive'] = ( $static_page > 0 ? false : trim(str_replace( home_url(), '', post_permalink($static_page) ), '/') );
*/
...
/* Album Post Type (album)
   ========================================================================== */
	...
	$static_page = get_iron_option('page_for_albums');

	$album_args = $default_args;
/*
	if ( get_option('permalink_structure') )
		$album_args['has_archive'] = ( $static_page > 0 ? false : trim(str_replace( home_url(), '', post_permalink($static_page) ), '/') );
*/
