...
if ( ! defined('Redux_OPTIONS_DIR') ) {
	define('Redux_OPTIONS_DIR', get_stylesheet_directory() . '/admin/options/');
}
...
function setup_framework_options() {
	global $redux_args, $redux_sections;
	...
	// Default: null
	$redux_args['dev_mode_icon_class'] = 'icon-large';
	...
	// This is ignored unless $redux_args['icon_type'] = 'iconfont'
	// Default: null
	$redux_args['import_icon_class'] = 'icon-large';
	...
	// Default: Options
	$redux_args['menu_title'] = __('IronBand', IRON_TEXT_DOMAIN);

	// Set a custom page title for the options page.
	// Default: Options
	$redux_args['page_title'] = __('IronBand Options', IRON_TEXT_DOMAIN);

	// Set a custom page slug for options page (wp-admin/themes.php?page=***).
	// Default: redux_options
	$redux_args['page_slug'] = 'ironband_options';
...
*/
	...
	$redux_sections[] = array(
		'icon'       => 'th-large',
		'icon_class' => 'icon-large',
		'title'      => _x('Widgets & Sidebars', 'Theme Options', IRON_TEXT_DOMAIN),
		...
		'fields'     => array(
			array(
				...
				'std'      => array(
					...
					IRON_SIDEBAR_PREFIX . '3' => array(
						'sidebar_name' => 'Home : Two Columns',
						'sidebar_desc' => _x('This is the default, two columns, view on the Home page. By default, it features the IronBand Audio Player and Twitter feed.', 'Theme Options', IRON_TEXT_DOMAIN),
						'sidebar_grid' => 2,
						'order_no'     => 4
					),
					IRON_SIDEBAR_PREFIX . '4' => array(
						'sidebar_name' => 'Home : One Column',
						'sidebar_desc' => _x('This is the default, one column, view on the Home page. By default, it features the latest blog posts, events, and videos.', 'Theme Options', IRON_TEXT_DOMAIN),
						'sidebar_grid' => 1,
						'order_no'     => 5
					),
				),
				'options' => array(
					...
					'fields' => array(
						...
						array(
							'id'      => 'sidebar_grid',
							'type'    => 'select',
							'title'   => _x('Column Count', 'Theme Options', IRON_TEXT_DOMAIN),
							'desc'    => _x('These are used in conjunction with widgets for the layout manager on the Home page and foot of the site. Certain locations, such as the sidebars, will ignore this attribute.', 'Theme Options', IRON_TEXT_DOMAIN),
							'options' => array(
								1 => '1 column (one whole)',
								2 => '2 columns (one half)'
							),
							'std'      => 1
						),
					)
			...
			array(
				'id' => 1,
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Widget Labels', IRON_TEXT_DOMAIN) . '</h4>'
			),
			array(
				'id' => 2,
				'type' => 'info',
				'desc' => '<h5 class="title">' . __('Radio Widget', IRON_TEXT_DOMAIN) . '</h5>'
			),
			array(
				'id' => 'albums_widget_action_label',
				'type' => 'text',
				'title' => __('Albums Block Call-To-Action', IRON_TEXT_DOMAIN),
				'desc' => '<br />' . __('Leave field empty to default to "+ All <em>[albums page title]</em>".', IRON_TEXT_DOMAIN)
			),
			array(
			...
			array(
				'id' => 3,
				'type' => 'info',
				'desc' => '<h5 class="title">' . __('Twitter Widget', IRON_TEXT_DOMAIN) . '</h5>'
			),
			array(
			...
			array(
				'id' => 4,
				'type' => 'info',
				'desc' => '<h5 class="title">' . __('Recent Posts Widget', IRON_TEXT_DOMAIN) . '</h5>'
			),
			array(
			...
			array(
				'id' => 6,
				'type' => 'info',
				'desc' => '<h5 class="title">' . __('Recent Videos Widget', IRON_TEXT_DOMAIN) . '</h5>'
			),
			array(
			...
			array(
				'id' => 5,
				'type' => 'info',
				'desc' => '<h5 class="title">' . __('Upcoming Events Widget', IRON_TEXT_DOMAIN) . '</h5>'
			),
			array(
	...
	$redux_sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'std'   => 'ironband_sidebar_2'
			),
			array(
				'id' => 2,
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Logos', IRON_TEXT_DOMAIN) . '</h4>'
			),
			array(
				'id' => 'footer_logo',
				'type' => 'upload',
	...
	$redux_sections[] = array(
		'icon' => 'home',
		'icon_class' => 'icon-large',
		'title' => __('Home Page', IRON_TEXT_DOMAIN),
		...
		'fields' => array(
			...
			array(
				'id' => 1,
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Slideshow', IRON_TEXT_DOMAIN) . '</h4>'
			),
			array(
				'id' => 'slide_more_label',
				'type' => 'text',
	...
	$redux_sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc' => iron_deprecated_notice( 'This field', '1.6', 'the Iron Newsletter Widget' ),
