...
$iron_updates = array(
	...
	array(
		...
		'changes' => array(
			...
			'Widget-Ready!',
			'Fixed Media Manager disabling image selection; related to mismatched paths with included Advanced Custom Fields.',
			'Updated Advanced Custom Fields to 4.3.0',
			'Updated ACF Repeater Field to 1.1.0',
		)
	),
	array(
		'version' => '1.6',
		...
		'changes' => array(
			...
			'Widget-Ready!',
			'Deprecated Homepage Blocks in favor of WordPress Widgets.',
			'Deprecated the following theme options : sidebar_for_posts, sidebar_for_videos, newsletter_label',
			'Removed the following theme options : post_type_label, radio_playlist_label, twitter_widget_label, posts_widget_label, gigs_widget_label, videos_widget_label, twitter_username',
			'Refactored all static widgets into proper, albeit basic, WordPress Widgets. Calls-to-action are managed by Widget Areas instead of Home Page, under Theme Options.',
			'Customizable widget area for the foot of your site; where the newsletter module used to be.',
			'Each Post, Page, and Video, now has a customizable widget area (either left, right, or disabled).',
			'Added custom widget that allows you to choose a taxonomy to display its terms.',
			'Started reorganizing style.css based on principles of idiomatic CSS.',
			'Improved CSS/JS of carousels, much more flexible.',
			'Implemented a CSS "panel" pattern for widgets and sidebar blocks.',
			'Cleaned up default data importation system; added setting up of widgets and sidebars.',
			'Added IronBand Theme Options to WordPress Toolbar.',
			'Theme Options : Renamed "Homepage Blocks" to "Home Page"',
			'Redux > Widget Area Select : Added field to select, including NULL, a widget area; similar to Menu Location Select.',
			'Redux > Menu Location Select : Cleaned up PHP syntax and added NULL option.',
			'Redux : Added Group Field.',
			'Redux > Background Field : Replaced jQuery UI Tooltip with Bootstrap Tooltip and Bootstrap Popover components to reduce theme conflicts with other jQuery UI components.',
		)
	),
	array(
		'version' => '1.5.1',
