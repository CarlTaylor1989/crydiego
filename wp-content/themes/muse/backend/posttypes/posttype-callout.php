...
?>
	...
	<style type="text/css" media="screen">
		#icon-edit.icon32-posts-callout { background: url("<?php echo get_template_directory_uri(); ?>/backend/images/icons/icon-callout32.png") no-repeat; }
    </style>
	...
	$meta_boxes[] = array(
		...
		'fields'			=> array(
			...
			array(
				...
				'desc'				=> __('Add or select the background color of the callout block. Default: #cd503c.', 'gp'),
				'id'				=> GP_SHORTNAME . '_callout_block_background',
				'std'				=> $color_secondary,
				'type'				=> 'picker_color'
			)
		)
