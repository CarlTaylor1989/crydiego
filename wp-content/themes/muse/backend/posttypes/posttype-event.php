...
?>
	...
	<style type="text/css" media="screen">
		#icon-edit.icon32-posts-event { background: url("<?php echo get_template_directory_uri(); ?>/backend/images/icons/icon-event32.png") no-repeat; }
    </style>
...
function gp_register_metabox_event() {
	...
	*/
	...
	$meta_boxes[] = array(
		'id'				=> 'gp-metabox-posttype-event-options-block',
		'title'				=> __('Event Block Options', 'gp'),
		'pages'				=> array('event'),
		'context'			=> 'normal',
		'priority'			=> 'high',
		'fields'			=> array(
			array(
				...
				'desc'				=> __('Add or select the background color of the event block. Default: #14191e.', 'gp'),
				'id'				=> GP_SHORTNAME . '_event_block_background',
				'std'				=> $color_tertiary,
				'type'				=> 'picker_color'
			)
		)
