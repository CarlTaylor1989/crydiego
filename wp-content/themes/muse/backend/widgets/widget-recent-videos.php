...
class gp_Widget_Recent_Videos extends WP_Widget {
	
	function __construct() {
		
		$widget_options = array(
			'classname'								=> 'widget_recent_videos',
			'description'							=> __('Widget that displays recent videos.', 'gp')
		);
		
		$control_options = array(
			'id_base'								=> 'widget_recent_videos'
		);
		
		$this->WP_Widget('widget_recent_videos', __('Muse: Recent Videos', 'gp'), $widget_options, $control_options);
	...
	function form($instance) {
		...
		$defaults = array(
			'widget_title'							=> __('Recent Videos', 'gp'),
			'post_number'							=> '3'
		);
