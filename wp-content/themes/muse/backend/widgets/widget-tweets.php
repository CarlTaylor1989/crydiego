...
class gp_Widget_Tweets extends WP_Widget {
	...
	function gp_Widget_Tweets() {
		...
		$this->WP_Widget('widget_tweets', __('Muse: Tweets', 'gp'), $widget_options, $control_options);
	...
	function widget($args, $instance) {
		...
		$tweets = get_transient($twitter_username . '-' . $twitter_number . '-' . $twitter_duration);
		...
		if (!$tweets) {
			...
			if (!$twitter) {
				...
				set_transient($twitter_username . '-' . $twitter_number . '-' . $twitter_duration, $tweets, $time);
	...
	function update($new_instance, $old_instance) {
		...
		delete_transient($old_instance['twitter_username'] . '-' . $old_instance['twitter_number'] . '-' . $old_instance['twitter_duration']);
		
		$instance = $old_instance;

		$instance['widget_title']			= $new_instance['widget_title'];
		$instance['twitter_username']		= $new_instance['twitter_username'];
		$instance['twitter_number']			= $new_instance['twitter_number'];
	...
	function form($instance) {
		...
		$twitter_number						= isset($instance['twitter_number']) ? esc_attr($instance['twitter_number']) : '';
	...
	?>
        ...
        <p>
            ...
            <input type="text" id="<?php echo $this->get_field_id('twitter_number'); ?>" name="<?php echo $this->get_field_name('twitter_number'); ?>" type="text" value="<?php echo $twitter_number; ?>" />
